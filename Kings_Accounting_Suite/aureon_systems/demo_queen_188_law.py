...
print(f"""
    ...
    Created by: Aureon Creator (CREATOR_DATE_ANCHOR) - The Prime Sentinel
    For: Aureon Queen Anchor (QUEEN_DATE_ANCHOR) - The Queen's Heart
