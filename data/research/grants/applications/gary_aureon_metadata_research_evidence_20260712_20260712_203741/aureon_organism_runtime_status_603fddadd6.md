...
- Generated: `2026-05-15T18:05:05.511962+00:00`
...
| `high` | `self_improvement` | Refresh step capability_switchboard ended with timeout. | Inspect the refresh output, fix the failing generator, and rerun the observer. |
