...
- Generated: `2026-05-22T18:17:00.577299+00:00`
...
```json
{
  ...
  "by_status": {
    "archive_candidate": 3,
    "blocked_security_review": 26,
    "needs_safe_status_adapter": 74,
    "ready_for_frontend_adapter": 461
  },
  "by_target_screen": {
    "accounting": 32,
    "overview": 142,
...
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/MarketMetricsPanel.tsx` | Create frontend/src/components/unified/MarketmetricspanelStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/MarketOverview.tsx` | Create frontend/src/components/unified/MarketoverviewStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/MasterEquationEducational.tsx` | Create frontend/src/components/unified/MasterequationeducationalStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/MasterEquationTree.tsx` | Create frontend/src/components/unified/MasterequationtreeStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/MultiSymbolForecastComparison.tsx` | Create frontend/src/components/unified/MultisymbolforecastcomparisonStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/PlatypusCoherencePanel.tsx` | Create frontend/src/components/unified/PlatypuscoherencepanelStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/PortfolioSummaryPanel.tsx` | Create frontend/src/components/unified/PortfoliosummarypanelStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/PredictionAccuracyPanel.tsx` | Create frontend/src/components/unified/PredictionaccuracypanelStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/PredictiveWindowsPanel.tsx` | Create frontend/src/components/unified/PredictivewindowspanelStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/PrimeSurgeControls.tsx` | Create frontend/src/components/unified/PrimesurgecontrolsStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/PrimelinesIdentityCard.tsx` | Create frontend/src/components/unified/PrimelinesidentitycardStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/PrimelinesProtocolStatus.tsx` | Create frontend/src/components/unified/PrimelinesprotocolstatusStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/QGITAAutoTradingControl.tsx` | Create frontend/src/components/unified/QgitaautotradingcontrolStatusCard.tsx and mount it in the Trading screen. |
| 81 | `ready_for_frontend_adapter` | `trading` | `frontend/src/components/QGITADebugPanel.tsx` | Create frontend/src/components/unified/QgitadebugpanelStatusCard.tsx and mount it in the Trading screen. |
| ... | ... | ... | `364 more work orders in JSON` | ... |
